          ...
          <div className="pt-6 border-t border-slate-400/20 dark:border-slate-600/20">
            ...
            <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
              <a
                ...
                className="rounded-xl bg-linear-to-r from-cyan-600/70 to-cyan-500/70 hover:from-cyan-600/80 hover:to-cyan-500/80 px-6 py-3 text-sm font-medium text-white transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-300/60"
              >
                📧 Email Me
              </a>
              <a
